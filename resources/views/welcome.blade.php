...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <nav class="hidden lg:flex items-center justify-between 
        ...
        <div class="text-xl font-semibold selection:bg-[#fb695c]">AI Ueo</div>
    ...
    <!-- CHAT WRAPPER -->
    <div class="flex-1 flex justify-center items-center lg:items-start 
                lg:pt-8">

        <div class="w-full sm:max-w-xl md:max-w-2xl lg:max-w-4xl 
                    h-[100dvh] lg:h-[85vh]
                    bg-white lg:shadow-xl lg:rounded-2xl 
